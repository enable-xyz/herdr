...
pub struct KeysConfig {
    ...
    /// Collapse the sidebar. Unset by default.
    pub hide_sidebar: BindingConfig,
    /// Expand the sidebar. Unset by default.
    pub show_sidebar: BindingConfig,
...
pub(crate) struct KeysConfigOverlay {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    hide_sidebar: Option<BindingConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
    show_sidebar: Option<BindingConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl<'de> Deserialize<'de> for KeysConfig {
        ...
        D: Deserializer<'de>,
    {
        ...
        apply_field!(hide_sidebar);
        apply_field!(show_sidebar);
        apply_field!(indexed);
        apply_field!(command);
...
impl KeysConfig {
    ...
    pub(crate) fn local_profile(&self, keybinds: &Keybinds) -> KeysConfigOverlay {
        ...
        copy_effective_action_field!(hide_sidebar, keybinds.hide_sidebar);
        copy_effective_action_field!(show_sidebar, keybinds.show_sidebar);
...
pub struct UiConfig {
    ...
    /// Center desktop pane content at up to 80 columns while native chrome remains full-size.
    /// Narrower areas use their available width. A single pane's scrollbar moves to the window
    /// edge when a right margin exists. Mobile layout is unchanged. Default: false.
...
impl Default for KeysConfig {
    fn default() -> Self {
        Self {
            ...
            hide_sidebar: BindingConfig::empty(),
            show_sidebar: BindingConfig::empty(),

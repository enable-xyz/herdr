...
pub struct Keybinds {
    ...
    pub hide_sidebar: ActionKeybinds,
    pub show_sidebar: ActionKeybinds,
...
impl Config {
    pub(super) fn validated_keybinds(&self) -> (Option<String>, KeyCombo, Vec<String>, Keybinds) {
        ...
        let mut keybinds = Keybinds {
            ...
            hide_sidebar: empty_action!(),
            show_sidebar: empty_action!(),
        ...
        for source in [BindingSource::User, BindingSource::Default] {
            ...
            apply_action!(keybinds.hide_sidebar, hide_sidebar, source);
            apply_action!(keybinds.show_sidebar, show_sidebar, source);
